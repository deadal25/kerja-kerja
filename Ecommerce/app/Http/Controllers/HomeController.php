...
class HomeController extends Controller
{
    ...
    public function confirmorder(Request $request) {
        ...
        foreach ($request->productname as $key =>$productname) {
            $order = new order; // Pastikan namespace dan nama model sudah diimpor dengan benar
        ...
        // Tambahkan logika atau redirect sesuai kebutuhan Anda setelah menyimpan semua pesanan
    }
