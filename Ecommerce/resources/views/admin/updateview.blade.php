      ...
      @include('admin.navbar')
        ...
        {{-- <div style="padding:15px;">
            ...
            <select 
             ...
             <option style="color: black" name="category" required=''> Add a Category here </option>
            <option style="color: black"  value="{{ $data->category }}" selected=" ">{{ $data->category }}</option>
        ...
        <div style="padding:15px;">
            <label >Diskon Price</label>

            <input style="color: black" type="number" name="dis_price" value="{{ $data->discount_price }}" required="">
